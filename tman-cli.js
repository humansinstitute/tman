...
let currentPage = 0;
// Prefer TMAN_HOME for all config; fall back to legacy envs/paths
const TMAN_HOME = process.env.TMAN_HOME || process.env.WINGMAN_HOME || os.homedir();
const WINGMAN_CONFIG_PATH = path.join(TMAN_HOME, '.tman-config.json');
...
function showHeader() {
  ...
  console.log(`${colors.cyan}║${colors.white}${colors.bright}                        tman CLI                         ${colors.reset}`);
  console.log(`${colors.cyan}╚═══════════════════════════════════════════════════════════╝${colors.reset}`);
  console.log();
}
...
function showWelcomeHeader() {
  console.clear();
  console.log(`${colors.cyan}╔═══════════════════════════════════════════════════════════╗${colors.reset}`);
  console.log(`${colors.cyan}║${colors.white}${colors.bright}                 Welcome to tman!                         ${colors.reset}`);
...
async function setupProjectFolders() {
  ...
  console.log(`${colors.green}Welcome to tman!${colors.reset}`);
...
async function main() {
  ...
  // Check if this is the first run after go-tman
  if (isFirstRun()) {
